...
const FACTORY_PRESETS: &[(&str, &str, &str)] = &[
    ...
    // Arpeggiator presets
    ("Arp", "arp_classic_trance", include_str!("../presets/arp_classic_trance.json")),
    ("Arp", "arp_acid_bubbles", include_str!("../presets/arp_acid_bubbles.json")),
    ("Arp", "arp_dreamy_pad", include_str!("../presets/arp_dreamy_pad.json")),
    ("Arp", "arp_dark_minor", include_str!("../presets/arp_dark_minor.json")),
    ("Arp", "arp_pluck_sequence", include_str!("../presets/arp_pluck_sequence.json")),
    ("Arp", "arp_random_glitch", include_str!("../presets/arp_random_glitch.json")),
    ("Arp", "arp_warm_keys", include_str!("../presets/arp_warm_keys.json")),
    ("Arp", "arp_retro_8bit", include_str!("../presets/arp_retro_8bit.json")),
    ("Arp", "arp_ambient_shimmer", include_str!("../presets/arp_ambient_shimmer.json")),
    ("Arp", "arp_funky_bass", include_str!("../presets/arp_funky_bass.json")),
    ("Arp", "arp_stab_house", include_str!("../presets/arp_stab_house.json")),
    ("Arp", "arp_ethereal_bells", include_str!("../presets/arp_ethereal_bells.json")),
    // Accordion
